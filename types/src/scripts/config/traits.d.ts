...
export { actionTraits, alignmentTraits, ancestryItemTraits, ancestryTraits, classTraits, consumableTraits, creatureTraits, damageTraits, elementalTraits, energyDamageTypes, featTraits, hazardTraits, magicSchools, magicTraditions, npcAttackTraits, otherWeaponTags, preciousMaterials, spellTraits, spellOtherTraits, vehicleTraits, weaponTraits, };
