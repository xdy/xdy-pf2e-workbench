...
interface AdjustDarknessLevelRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "adjustDarknessLevel";
    system: ModelPropsFromSchema<AdjustDarknessLevelRegionBehaviorSchema>;
}
interface ExecuteMacroRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "executeMacro";
    system: ModelPropsFromSchema<ExecuteMacroRegionBehaviorTypeSchema>;
}
interface ExecuteScriptRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "executeScript";
...
interface SuppressWeatherRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "suppressWeather";
    system: ModelPropsFromSchema<SuppressWeatherRegionBehaviorTypeSchema>;
}
interface TeleportTokenRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "teleportToken";
    system: ModelPropsFromSchema<TeleportTokenRegionBehaviorTypeSchema>;
}
interface ToggleBehaviorRegionBehavior<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "toggleBehavior";
    system: ModelPropsFromSchema<ToggleBehaviorRegionBehaviorTypeSchema>;
}
interface EnvironmentRegionBehaviorPF2e<TParent extends RegionDocument = RegionDocument> extends BaseRegionBehavior<TParent> {
    type: "environment";
...
type RegionBehaviorInstance<TParent extends RegionDocument = RegionDocument> = RegionBehaviorInstances<TParent>[keyof RegionBehaviorInstances];
type RegionBehaviorInstanceType = RegionBehaviorInstance["type"];
export type { EnvironmentRegionBehaviorPF2e, RegionBehaviorInstance, RegionBehaviorInstances, RegionBehaviorInstanceType, RegionEventPF2e, };
