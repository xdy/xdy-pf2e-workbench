import { Abilities, BaseCreatureData, BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureHitPoints, CreatureInitiative, CreatureSystemData, CreatureSystemSource, CreatureTraitsData, CreatureTraitsSource, HeldShieldData, LabeledSpeed, SaveData, SkillAbbreviation, SkillData } from "@actor/creature/data";
...
interface NPCData extends Omit<NPCSource, "data" | "effects" | "items" | "token" | "type">, BaseCreatureData<NPCPF2e, "npc", NPCSystemData, NPCSource> {
    flags: NPCFlags;
}
...
declare type NPCSavesSource = Record<SaveType, {
    value: number;
    saveDetail: string;
}>;
...
declare type NPCDetails = CreatureDetails & {
...
export { NPCArmorClass, NPCAttributes, NPCAttributesSource, NPCData, NPCHitPoints, NPCPerception, NPCSaveData, NPCSkillData, NPCSource, NPCStrike, NPCSystemData, NPCSystemSource, NPCTraitsData, };
