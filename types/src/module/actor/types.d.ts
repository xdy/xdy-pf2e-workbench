...
import { ABILITY_ABBREVIATIONS, DC_SLUGS, SAVE_TYPES, SKILL_ABBREVIATIONS, SKILL_LONG_FORMS, UNAFFECTED_TYPES } from "./values";
...
interface StrikeSelf<TActor extends ActorPF2e = ActorPF2e, TStatistic extends StatisticCheck | StatisticModifier | null = StatisticCheck | StatisticModifier | null, TItem extends AttackItem | null = AttackItem | null> {
    actor: TActor;
...
interface StrikeRollContext<TActor extends ActorPF2e, TStatistic extends StatisticCheck | StatisticModifier | null = StatisticCheck | StatisticModifier | null, TItem extends AttackItem | null = AttackItem | null> {
    /** Roll options */
    options: Set<string>;
...
interface StrikeRollContextParams<TStatistic extends StatisticCheck | StatisticModifier | null = StatisticCheck | StatisticModifier | null, TItem extends AttackItem | null = AttackItem | null> {
...
type AttackRollContextParams<TStatistic extends StatisticCheck | StatisticModifier = StatisticCheck | StatisticModifier, TItem extends AttackItem | null = AttackItem | null> = StrikeRollContextParams<TStatistic, TItem>;
interface AttackRollContext<TActor extends ActorPF2e, TStatistic extends StatisticCheck | StatisticModifier = StatisticCheck | StatisticModifier, TItem extends AttackItem | null = AttackItem | null> extends StrikeRollContext<TActor, TStatistic, TItem> {
    dc: CheckDC | null;
}
...
export { AbilityString, ActorAlliance, ActorDimensions, ActorInstances, ApplyDamageParams, AttackItem, AttackRollContext, AttackRollContextParams, AttackTarget, AuraColors, AuraData, AuraEffectData, DCSlug, EmbeddedItemInstances, IWRType, ImmunityType, ResistanceType, SaveType, SkillAbbreviation, SkillLongForm, StrikeRollContext, StrikeRollContextParams, StrikeSelf, UnaffectedType, WeaknessType, };
