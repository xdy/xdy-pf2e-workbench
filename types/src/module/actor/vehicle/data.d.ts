import { ActorSystemData, ActorAttributes, BaseActorSourcePF2e, BaseHitPointsSource, ActorTraitsData, ActorSystemSource, ActorDetailsSource, ActorHitPoints } from "@actor/data/base";
