...
export function pf2eRerollHook(
    ...
    if (die && result && getModuleSetting("heroPointRules") === "keeleysHeroPointRule") {
        newRoll.terms.push(
    ...
    } else if (die && result && getModuleSetting("heroPointRules") === "heroicRerolls") {
    ...
    } else if (getModuleSetting("heroPointRules") === "useHighestHeroPointRoll") {
