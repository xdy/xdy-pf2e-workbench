    ...
    public static override get settings(): Record<string, SettingRegistration> {
        return {
            ...
            selectCurrentCombatantOnTurnStart: {
                name: `${MODULENAME}.SETTINGS.selectCurrentCombatantOnTurnStart.name`,
                hint: `${MODULENAME}.SETTINGS.selectCurrentCombatantOnTurnStart.hint`,
                scope: "client",
                config: true,
                default: false,
                type: Boolean,
            ...
            clearCombatantTargetsOnTurnEnd: {
                name: `${MODULENAME}.SETTINGS.clearCombatantTargetsOnTurnEnd.name`,
                hint: `${MODULENAME}.SETTINGS.clearCombatantTargetsOnTurnEnd.hint`,
                scope: "client",
                config: true,
                default: false,
                type: Boolean,
            ...
            rememberAndReaddCombatantTargets: {
                name: `${MODULENAME}.SETTINGS.rememberAndReaddCombatantTargets.name`,
                hint: `${MODULENAME}.SETTINGS.rememberAndReaddCombatantTargets.hint`,
                scope: "client",
                config: true,
                default: false,
                type: Boolean,
